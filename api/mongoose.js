...
module.exports = function () {
  ...
  if(process.env.NODE_ENV == 'development' && process.env.NETWORK_MODE == 'false') {
    logger.debug('Mongoose connection : ' + JSON.stringify(app.get('mongodbDocker')) + '\t\t Node environment : ' + JSON.stringify(process.env.NODE_ENV) + '\t\t DOCKER_COMPOSE : ' + JSON.stringify(process.env.DOCKER_COMPOSE));
