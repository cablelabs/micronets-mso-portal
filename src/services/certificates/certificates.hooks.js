  ...
  before : {
    ...
    create : [
      async function ( hook ) {
        ...
        const result = sessionsList.data.map ( ( session , sessionIndex ) => {
        ...
        const subscriber = await hook.app.service ( '/internal/subscriber' ).find ( { query : { id : result[ 0 ].subscriberId } } );
